...
export default async function init(html: HTMLElement, url: string, msg: unknown, headers: object, events: IEvents, actions: IActions, ...components: ((html: HTMLElement, url: string, msg: unknown, headers: object, query: object) => Promise<unknown>)[]) {
